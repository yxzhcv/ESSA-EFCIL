...
from utils.model.module.classifier import build_classifier, build_sfan
...
class my_model(ExemplarHandler):
    def __init__(self, backbone=None, pretrained=False, args=None):
        ...
        self.args = args
        self.sfan = build_sfan(args, self.fc_features)
    ...
    def sfan_extractor(self, features):
        fanout = self.sfan(features)
        return fanout
